  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 p-4 rounded-lg mb-6">
        <h3 className="text-lg font-medium text-blue-900 mb-2">Snooker Table Reservation</h3>
        <p className="text-sm text-gray-600">
          Book a snooker table for your session. Choose your preferred duration, date, and time.
        </p>
      </div>
